...
<div className="w-full aspect-[3/4] overflow-hidden rounded-xl">
  ...
  <a
  href="#konsultacja"
  className="px-4 py-3 rounded-2xl bg-white flex items-center justify-center shadow-[0_0_15px_rgba(191,0,255,0.8)] hover:shadow-[0_0_25px_rgba(191,0,255,1)] transition-all duration-300"
>
  {/* Mobile: ikona */}
